...
import {  BarChart, Book, CalendarMonth, Diamond, Preview, RoomService, ShoppingCart } from '@mui/icons-material'
         ...
         {/* <SidebarHeader rtl={rtl} style={{ marginBottom: '24px', marginTop: '16px' }} />*/}
          <div style={{ flex: 1, marginBottom: '32px' }}>
            ...
            <Menu menuItemStyles={menuItemStyles}>
              ...
              <SubMenu label="Maps" icon={<Preview />}>
                <MenuItem> Google maps</MenuItem>
                <MenuItem> Open street maps</MenuItem>
              </SubMenu>
              <SubMenu label="Theme" icon={<Preview />}>
            ...
            <Menu menuItemStyles={menuItemStyles}>
              <MenuItem icon={<CalendarMonth />} suffix={<Badge variant="success">New</Badge>}>
                Calendar
              </MenuItem>
