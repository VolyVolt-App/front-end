...
export const ImpactSociaux = () => {
  ...
  return (
    ...
    <Box> {/* https://www.google.com/maps/d/viewer?mid=1ztgqsEQAZ5ej0DNawjHzxl10_N5x1f8&usp=sharing */}
      ...
      <iframe src="https://www.google.com/maps/d/viewer?mid=1ztgqsEQAZ5ej0DNawjHzxl10_N5x1f8&usp=sharing" width="600" height="450" frameborder="0" style={{border:0}} allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
    </Box>
    {/* end map */}
