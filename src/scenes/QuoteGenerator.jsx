    ...
    <Box>
        ...
        <Grid container>
            <Grid item xs={12} md={6} sx={{bgcolor: 'white', p:{xs:1,sm:2,md:3,lg:4}, borderRadius: 1}}>
                <TextField label='Nom de l’organisme' fullWidth size='small' sx={{pb:1}}/>
                <TextField label='Adresse E-mail' fullWidth size='small' sx={{py:1}}/>
                <TextField label='Numéro de téléphone' fullWidth size='small'sx={{py:1}}/>
                <Stack direction={'row'} spacing={1}sx={{py:1}}>
                    <TextField label='Localité' fullWidth size='small'/>
                    <TextField label='Distance' fullWidth size='small'/>
                </Stack>
                <TextField label='Nombres de ménages bénéficiaires' fullWidth size='small'sx={{py:1}}/>
                <TextField label='Nombres de points de rechargement souhaités' fullWidth size='small'sx={{py:1}}/>
